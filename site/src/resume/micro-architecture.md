...
Establish patterns for "MicroService" and "MicroFrontend" architecture and scale these patterns to other teams
...
Analyzed UI/UX specifications to engineer design-system tokens and components which serve as building-blocks for features. Assist other teams and team members with their own features and integrations
